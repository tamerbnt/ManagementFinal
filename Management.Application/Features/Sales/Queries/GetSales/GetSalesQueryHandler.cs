        ...
        IRequestHandler<GetTotalRevenueQuery, Result<decimal>>
    {
        ...
        public async Task<Result<List<SaleDto>>> Handle(GetSalesHistoryQuery request, CancellationToken cancellationToken)
        {
            ...
            var dtos = sales
                ...
                .Select(s => new SaleDto
                {
                    ...
                    TotalOriginalAmount = s.SubtotalAmount.Amount,
                    TotalDiscountAmount = s.SubtotalAmount.Amount - s.TotalAmount.Amount,
                    AppliedPromotionName = s.AppliedPromotionName,
        ...
        public async Task<Result<SaleDto>> Handle(GetSaleDetailsQuery request, CancellationToken cancellationToken)
        {
            ...
            return Result.Success(new SaleDto
            {
                ...
                TotalOriginalAmount = sale.SubtotalAmount.Amount,
                TotalDiscountAmount = sale.SubtotalAmount.Amount - sale.TotalAmount.Amount,
                AppliedPromotionName = sale.AppliedPromotionName,

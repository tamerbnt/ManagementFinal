...
namespace Management.Application.Features.Products.Queries.GetProducts
{
    ...
    public record SearchProductsPagedQuery(string SearchTerm, int Page, int PageSize, Guid? FacilityId = null, Management.Domain.Enums.ProductCategory? Category = null) : IRequest<Result<PagedResult<ProductDto>>>;
